    ...
    public class LevenshteinDistance {
        ...
        public Integer apply(final CharSequence left, final CharSequence right) {
        	final String lowercaseLeft = left.toString().toLowerCase();
        	final String lowercaseRight = right.toString().toLowerCase();
        	
        	if (threshold != null) {
                return limitedCompare(lowercaseLeft, lowercaseRight, threshold);
            }
            return unlimitedCompare(lowercaseLeft, lowercaseRight);
        }
